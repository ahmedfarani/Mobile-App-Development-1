package com.example.explicitlntent;
...
import com.example.explicitlntent.databinding.ActivityMainBinding;
...
//        mainBinding.textReply.setVisibility(INVISIBLE);

        mainBinding.buttonSend.setOnClickListener(view -> {

            if (!TextUtils.isEmpty(mainBinding.editTextMessage.getText().toString())) {
