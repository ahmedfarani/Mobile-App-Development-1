...
import com.example.droidcafe3.databinding.ActivityOrderBinding;
...
//        orderBinding.radioGroupDelivery.setOnCheckedChangeListener((group, checkedId) -> {
//            if (group.getCheckedRadioButtonId() == R.id.radioButtonSame) {
//                deliveryMethod = orderBinding.radioButtonSame.getText().toString();
//            } else if (group.getCheckedRadioButtonId() == R.id.radioButtonNext) {
//                deliveryMethod = orderBinding.radioButtonNext.getText().toString();
//            } else if (group.getCheckedRadioButtonId() == R.id.radioButtonPick) {
...
//                phoneType = parent.getSelectedItem().toString();
...
//        });
    ...
    public void processDatePickerResult(int year, int month, int dayOfMonth) {
        ...
        date = (month_string + '/' + dayOfMonth_string + '/' + year_string);
    }
...
//        Toast.makeText(this, name + "-" + phoneType + "-" + deliveryMethod, Toast.LENGTH_SHORT).show();
    ...
    void showDialog() {
        ...
        builder.setMessage("Are you confirmed this order?");
